...
router_api.register(prefix='trail/games', viewset=GamesInTrailViewSet, basename='trail/games')
router_api.register(prefix='trail/game', viewset=GameInTrailViewSet, basename='trail/game')